...
如果需要自定义按钮样式，需要[移除 Button 原生样式](/docs/front-end/wechat-mini-program/solutions/remove-style-of-button.md)。
...
默认的标题为<TextHighlight>**当前小程序名称**</TextHighlight>，默认分享路径为<TextHighlight>**当前页面路径**</TextHighlight>（必须是<TextHighlight>**以 / 开头的完整路径**</TextHighlight>），默认图片为<TextHighlight>**当前页面的截图**</TextHighlight>。
