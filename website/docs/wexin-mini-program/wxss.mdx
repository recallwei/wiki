...
Use `@import` statement to import external style sheet. `@import` statement must followed by <TextHighlight>relative path</TextHighlight> and <TextHighlight>;</TextHighlight>.
