...
<li>
  <TextHighlight>Letters (A–Z and a–z), numbers (0–9)</TextHighlight>
  and the characters <code>'~'</code>, <code>'-'</code>, <code>'.'</code> and <code>
    '\_'
  </code> are <TextHighlight>left as-is</TextHighlight>.
</li>
<li>
  <code>+</code> is encoded by <code>%2B</code> - All other characters are
  encoded as a <TextHighlight>%HH hexadecimal representation</TextHighlight>
