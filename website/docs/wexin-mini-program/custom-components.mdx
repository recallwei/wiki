...
<Table
  data={{
    header: [
      { title: "Value", position: "start" },
      { title: "ComponentType", position: "center" },
      { title: "Affect inner style", position: "center" },
      { title: "Affect outer style", position: "center" },
      { title: "Affect by outer style", position: "center" },
      { title: "Remarks", position: "start" },
    ],
    body: {
